public class Main {
    ...
    private static void start() {
        ...
        System.out.println("result of get count of UPI is " + trackingInformation.getCounts(new HierarchicalTags("UPI")));
        System.out.println("result of get count of UPI, Karnataka is " + trackingInformation.getCounts(new HierarchicalTags("UPI", "Karnataka")));
        System.out.println("result of get count of UPI, Karnataka, Bangalore is " +
        ...
        System.out.println("result of get count of UPI is " + trackingInformation.getCounts(new HierarchicalTags("UPI")));
        System.out.println("result of get count of Wallet is " + trackingInformation.getCounts(new HierarchicalTags("Wallet")));
        System.out.println("result of get count of UPI, Karnataka, Bangalore is " +
                trackingInformation.getCounts(new HierarchicalTags("UPI", "Karnataka", "Bangalore")));
        System.out.println("result of get count of Bangalore is " + trackingInformation.getCounts(new HierarchicalTags("Bangalore")));
    }
}